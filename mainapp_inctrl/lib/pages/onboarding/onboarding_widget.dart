                                        ...
                                        children: [
                                          Expanded(
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'hxtwax0y' /* Manage investments with the he... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                        ...
                                        children: [
                                          Expanded(
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'uf9k1spp' /* Easily buy and sell stocks by ... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                        ...
                                        children: [
                                          Expanded(
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'q30ina4f' /* Build a green personal portfol... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      ...
                      text: FFLocalizations.of(context).getText(
                        'ypt7b97g' /* Step Towards Sustainability */,
                      ),
